...
const rev2 = {
  ...
  boxes: [
    ...
    [70, 145, 1260, 100, "Management Groups", palette.governance, "mgs"],
    ...
    [555, 345, 340, 130, "Internal Standard Load Balancer\nFrontend  10.2.2.20\nHTTP health probe /health", palette.hub, "ilb"],
