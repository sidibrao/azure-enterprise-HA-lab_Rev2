...
const rev2 = {
  title: "Azure Enterprise HA Landing Zone — Rev2 Target",
  subtitle: "ALZ skeleton • Multi-zone web tier • WAF • Governance and drift control",
  boxes: [
    [35, 95, 1330, 700, "Azure Tenant / Enterprise Scope", palette.white, "tenant"],
    [70, 145, 1260, 100, "REV2 SECTION 1 — ALZ MANAGEMENT GROUPS", palette.governance, "mgs"],
    [90, 180, 220, 45, "Platform", palette.white, "platform"],
    [330, 180, 220, 45, "Landing Zones", palette.white, "lz"],
    [570, 180, 180, 45, "Sandbox", palette.white, "sandbox"],
    [770, 180, 220, 45, "Decommissioned", palette.white, "decom"],
    [70, 280, 410, 470, "SECTION 1 — Connectivity / Hub  10.1.0.0/16", palette.hub, "hub"],
    [100, 345, 350, 125, "Azure Firewall\n10.1.0.4\nControlled egress + non-web DNAT", palette.security, "firewall"],
    [100, 505, 350, 105, "SECTION 4 — Application Gateway WAF_v2\nZone-redundant • OWASP • Custom rules", palette.ingress, "waf"],
    [100, 645, 350, 75, "Log Analytics / Defender / Sentinel", palette.governance, "monitor"],
    [520, 280, 810, 470, "Online Workload Spoke  10.2.0.0/16", palette.spoke, "spoke"],
    [555, 345, 340, 130, "SECTION 1 — Internal Standard Load Balancer\nFrontend  10.2.2.20\nBackend pool: Zone 1 + Zone 2\nHTTP health probe /health", palette.hub, "ilb"],
    [555, 520, 340, 150, "Availability Zone 1\n\nWeb VM 1  10.2.2.11\nNginx • No public IP", palette.white, "vm1"],
    [955, 520, 340, 150, "Availability Zone 2\n\nWeb VM 2  10.2.2.12\nNginx • No public IP", palette.white, "vm2"],
    [955, 345, 340, 130, "SECTION 9 — Governance + Drift\nRegions • Tags • Diagnostics\nPrivate access • RBAC • Exemptions", palette.governance, "policy"],
    [1020, 20, 300, 70, "Internet + DNS\nHTTPS application clients", palette.ingress, "internet"],
    [525, 700, 770, 35, "UDR: 0.0.0.0/0 → Azure Firewall 10.1.0.4", palette.security, "udr"],
  ],
  arrows: [
    [1170, 90, 275, 505, "1  HTTPS → WAF", palette.azure],
    [450, 555, 555, 410, "2  Approved request", palette.azure],
    [725, 475, 725, 520, "3a  Healthy backend", "#16a34a"],
    [800, 475, 1125, 520, "3b  Cross-zone HA", "#16a34a"],
    [555, 710, 450, 410, "4  Forced egress", "#dc2626"],
    [480, 405, 520, 405, "Hub / spoke peering", palette.azure],
    [275, 470, 275, 645, "5  Central logs", "#d97706"],
  ],
  notes: ["Layer 7 ingress", "Layer 3–7 network security", "Multi-zone workload", "Tenant governance"],
};
